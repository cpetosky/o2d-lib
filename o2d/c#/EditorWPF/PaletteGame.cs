...
namespace EditorWPF {
    class PaletteGame : Game {
        ...
        public PaletteGame(IntPtr handle) {
        ...
        protected override void LoadContent() {
            ...
            view = new o2dlib.View(new Rectangle(0, 0, 256, 600), 0, 0);
        ...
        protected override void Draw(GameTime gameTime) {
            if (Project != null && Project.CurrentMap != null) {
                ...
                Project.CurrentMap.Palette.Render(spriteBatch, view);
